    ...
    public class Program
    {
        public static void Main(String[] args)
        {
            ...
            **/
            ...
            webApplicationBuilder.WebHost.UseUrls("https://localhost:5501;http://localhost:5500;https://*:5501;http://*:5500");//指定Kestrel将侦听的URL。可以设置在appsettings.json中，使用JIT编译的方式获取（在此选用）。也可以在代码中硬编码设置。也可以在命令行中指定参数。
